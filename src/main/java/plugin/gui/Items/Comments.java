...
public class Comments extends JDialog {
    ...
    private void addComments(){
        ...
        commentPanel.add(new plugin.gui.Items.Comment(
                        new plugin.gui.Stabs.Comment("Username1",dtf.format(now),"Some rangom message: " + genRandomString(128),12,"Main.java"), KotoedPlugin.project)
                );
        commentPanel.add(new plugin.gui.Items.Comment(
                new plugin.gui.Stabs.Comment("Username1",dtf.format(now),"Some rangom message: " + genRandomString(128),12,"Test.java"),KotoedPlugin.project)
        );
    ...
    private void onSend() {
        commentPanel.add(new plugin.gui.Items.Comment(
              new plugin.gui.Stabs.Comment("Username",dtf.format(now),textArea.getText(),12,"Main.java"),KotoedPlugin.project
      ));
